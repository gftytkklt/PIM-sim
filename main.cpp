...
int main(){
    ...
    */
    ...
    // struct Convkernel kernel2{2, 5, 5, 1, 256, 384};
    struct Convkernel kernel3{3, 3, 3, 1, 256, 384};
    PIM_chip chip(3, 3, 10, 4, std::make_pair(1152, 256), std::vector<Convkernel>{kernel1, kernel3});
    chip.printDFG();
    chip.printSIMD();
