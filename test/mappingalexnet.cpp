...
protected:
    ...
    {1, {3,3}, {384,384}, std::vector<Depinfo>{{2,std::make_pair(1,384)}},{4, 4},{4, 4}},
    {2, {3,3}, {384,256}, std::vector<Depinfo>{{-1,std::make_pair(0,0)}},{4, 4},{4, 4}} 
    };
    HWInfo info = {{1152, 256}, 4, {2, 3}, 1};
