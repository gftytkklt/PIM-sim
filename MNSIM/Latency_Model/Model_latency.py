...
class Model_latency():
    def __init__(self, NetStruct, VirtualMappingInfo, mapping_matrix, SimConfig_path, multiple=None, TCG_mapping=None , Network=None):
        ...
        xbar_group_num = TCG_mapping.xbar_group_num
        xbar_size = TCG_mapping.xbar_size
        ...
        if NoC_Compute == 1:
            self.Noc_latency = interconnect_estimation(mapping_matrix, VirtualMappingInfo, Network, xbar_size, xbar_group_num)
        else:
